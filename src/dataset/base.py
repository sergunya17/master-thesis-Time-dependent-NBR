...
from src.settings import DATA_DIR, RANDOM_SEED
...
class NBRDatasetBase(ABC):
    ...
    def make_leave_one_basket_split(
        self, test_users_rate=0.5, random_basket=False, random_state=RANDOM_SEED
    ):
    ...
    def make_leave_two_baskets_split(self, random_baskets=False, random_state=RANDOM_SEED):
