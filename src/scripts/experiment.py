...
def run_experiment(
    ...
    evaluator_valid = Evaluator(
        dataset_df=data.val_df, cutoff_list=cutoff_list, batch_size=batch_size, verbose=verbose
    )
    evaluator_test = Evaluator(
        dataset_df=data.test_df, cutoff_list=cutoff_list, batch_size=batch_size, verbose=verbose
    )
